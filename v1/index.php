...
foreach ($files1 as $file1) {
   ...
   foreach ($lines1 as $line1) {
       $result0 = preg_split('/Date:/', $line1);
       if(count($result0)>1){
           $result_split_0 = explode(' ', $line1);
           
           $elem3 = $result_split_0[4];
           $elem3 = str_replace("/","_",$elem3);
           break;
       }
   }    
             ...
             if($result_split0[2] === "ALERT"){
                 ...
                 if($result_split0[4]==="IMEI"){
                            ...
                            if($result_split0[4] === "Ser"){
                                ...
                                if(strlen($elem5) === 3){                                    
                                    $createfile = $elem1 . ' ' . $elem2 . ' ' . $elemtwo . ' ' . 'from' . ' ' . $elem3 . ' ' . $elem4 . ' ' . $elem5 . ' ALERT.txt';                                
                                    $handle = fopen($dir1 . $createfile, 'w');
                                } elseif(strlen($elem5) === 2){
                                    $elem5 = '0'.$elem5;
                                    $createfile = $elem1 . ' ' . $elem2 . ' ' . $elemtwo . ' ' . 'from' . ' ' . $elem3 . ' ' . $elem4 . ' ' . $elem5 . ' ALERT.txt';                                
                    ...
                    if($result_split0[3]==="IMEI"){
                                ...
                                if($result_split0[3] === "Ser"){
                                    if(strlen($elem5) === 3){                                        
                                        $createfile = $elem1 . ' ' . $elem2 . ' ' . $elemtwo . ' ' . 'from' . ' ' . $elem3 . ' ' . $elem4 . ' ' . $elem5 . '.txt';
                                        $handle = fopen($dir1.$createfile, 'w');
                                    } elseif(strlen($elem5) === 2){
                                        $elem5 = '0'.$elem5;
                                        $createfile = $elem1 . ' ' . $elem2 . ' ' . $elemtwo . ' ' . 'from' . ' ' . $elem3 . ' ' . $elem4 . ' ' . $elem5 . '.txt';
